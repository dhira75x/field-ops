<template>
  <div class="bg-gray-300 bg-transparent w-full">
    <div class="p-8 rounded-lg shadow-2xl w-[600] h-[550px]">
      <h2 class="text-2xl font-bold mb-4 my-5">Add Splice Plan</h2>
      <!-- Your form goes here -->
      <form>
        <div class="mb-4 my-3">
          ...
          >
            <option value="option1">Joint Box Closure</option>
